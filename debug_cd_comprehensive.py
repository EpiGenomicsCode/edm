...
@click.option('--S', help='Student steps', type=int, default=8)
@click.option('--T_start', help='Initial teacher edges', type=int, default=256)
@click.option('--T_end', help='Final teacher edges', type=int, default=1024)
@click.option('--T_anneal_kimg', help='Teacher anneal horizon (kimg)', type=int, default=750)
