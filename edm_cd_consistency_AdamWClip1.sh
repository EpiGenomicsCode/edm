...
torchrun --standalone --nproc_per_node=4 train.py \
  --outdir=/work/hdd/bbse/xyou1/edm-training-runs/imagenet64-cd-s8/AdamWClip1_Dropout \
  ...
  --wandb_run=imagenet64-cd-s8-live-AdamW-Clip1-Dropout --wandb_tags=imagenet,cd,s8 --wandb_mode=online \
  --val=1 \
  --val_teacher=False \
  --snap=20 \
  --dump=20 \
