...
torchrun --standalone --nproc_per_node=4 train.py \
  --outdir=/work/hdd/bbse/xyou1/edm-training-runs/imagenet64-cd-s8/AdamWClip1 \
  ...
  --seed=1959836853 \
  --workers=4 \
  --resume=/u/xyou1/edm/training-runs/imagenet64-cd-s8/AdamWClip1/00001-imagenet-64x64-cond-adm-edm-gpus4-batch2048-fp16-cdS8-T64-1280/training-state-012292.pt