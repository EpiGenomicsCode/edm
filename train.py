...
@click.option('--importance_sampling', help='Use VP-equivalent importance weights for edge sampling (matches MSCD uniform-t)', metavar='BOOL', type=bool, default=True, show_default=True)
...
def main(**kwargs):
    ...
    if opts.consistency:
        ...
        c.loss_kwargs.update(
            ...
            importance_sampling=opts.importance_sampling,
        )
